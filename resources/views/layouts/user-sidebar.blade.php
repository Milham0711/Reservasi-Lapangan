    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white min-h-screen shadow-lg flex flex-col sticky top-0 h-screen">
            ...
            <nav class="p-4">
                ...
                <a href="{{ route('user.reservasi.index') }}" class="flex items-center space-x-3 px-4 py-3 {{ Request::routeIs('user.reservasi.index') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-50' }} rounded-lg mb-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
