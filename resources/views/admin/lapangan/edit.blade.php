...
<head>
    ...
    <title>Edit Lapangan - SportVenue</title>
        ...
        <main class="flex-1 p-8">
            <div class="max-w-3xl mx-auto">
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 mt-1">Ubah informasi lapangan berikut</p>
                </div>

                <!-- Form Edit Lapangan -->
                <div class="bg-white rounded-xl shadow-md p-8">
                    <form action="{{ route('admin.lapangan.update', $lapangan->lapangan_id_232112) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input 
                                    ...
                                    id="nama_lapangan" 
                                    name="nama_lapangan" 
                                    value="{{ old('nama_lapangan', $lapangan->nama_lapangan_232112) }}"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="futsal" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'futsal' ? 'selected' : '' }}>Futsal</option>
                                    <option value="badminton" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'badminton' ? 'selected' : '' }}>Badminton</option>
                                    <option value="sepak bola" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'sepak bola' ? 'selected' : '' }}>Sepak Bola</option>
                                    <option value="basket" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'basket' ? 'selected' : '' }}>Basket</option>
                                    <option value="voli" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'voli' ? 'selected' : '' }}>Voli</option>
                                    <option value="tenis" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'tenis' ? 'selected' : '' }}>Tenis</option>
                                    <option value="bulu tangkis" {{ old('jenis_lapangan', $lapangan->jenis_lapangan_232112) == 'bulu tangkis' ? 'selected' : '' }}>Bulu Tangkis</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    id="harga_per_jam" 
                                    name="harga_per_jam" 
                                    value="{{ old('harga_per_jam', $lapangan->harga_per_jam_232112) }}"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    id="kapasitas" 
                                    name="kapasitas" 
                                    value="{{ old('kapasitas', $lapangan->kapasitas_232112) }}"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="active" {{ old('status', $lapangan->status_232112) == 'active' ? 'selected' : '' }}>Active</option>
                                    <option value="maintenance" {{ old('status', $lapangan->status_232112) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                    <option value="inactive" {{ old('status', $lapangan->status_232112) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('status')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset($lapangan->gambar_232112) }}" alt="Gambar Lapangan" class="w-24 h-24 object-cover rounded-lg border">
                                </div>
                                @endif
                            ...
                            <div class="md:col-span-2">
                                ...
                                >{{ old('deskripsi', $lapangan->deskripsi_232112) }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
